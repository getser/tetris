...
label2 = tk.Label(frame1, text="Your current score is: " + str(score)).grid(
                                                                row=0,
                                                                column=1,
                                                                sticky="nw")
        ...
        for col in xrange(len(block[0])):
            ...
            if block[row][col] == 1:
                ball = canvas.create_oval(
                    ((paint_pos_col) * BLOCK_elem_width),
        ...
        for row in xrange(len(block)):
            for col in xrange(len(block[0])):
                if block[row][col] == 1:
                    ...
                    ball = canvas.create_oval(
                        ((paint_pos_col) * BLOCK_elem_width * 0.7),
...
def game_play():
    ...
    while True:
        ...
        label2 = tk.Label(frame1,
                          text="Your current score is: " + str(score)).grid(
                                                                row=0,
                                                                column=1,
                                                                sticky="nw")
#        time.sleep(0.01)
...
canvas.update()
Button1 = tk.Button(frame1, text="New game", command=game_play).grid(
                                                                row=1,
                                                                column=0,
                                                                sticky="we")
# Button1.pack()
